...
- [Face counts and decimation](https://xander-rudolph.github.io/game-asset-engine/guide/decimation) for what a budget really costs
- [Facings and camera angles](https://xander-rudolph.github.io/game-asset-engine/guide/facings) if a sprite faces the wrong way
- [Rigging](https://xander-rudolph.github.io/game-asset-engine/guide/rigging) for heavy meshes and weight transfer
- [Ground and terrain](https://xander-rudolph.github.io/game-asset-engine/guide/terrain) for tileable textures
- [Licensing](https://xander-rudolph.github.io/game-asset-engine/guide/licensing) before you ship anything
