...
```
Component inventory
  Skills (10)  asset-cleanup, asset-pipeline, concept-edit, daz-figure, game-music, ground-texture, hair-mesh, lip-sync, mesh-budget, pose-sheet
  MCP servers (1)  meshy

Projected token cost
  Always-on:   ~1,266 tok   added to every session
```
...
| "make a hairstyle for this character", "I need hair cards" | `hair-mesh` |
...
| `hair-mesh` | Hair cards grown on a scalp, with their own maps, placed on a figure |
